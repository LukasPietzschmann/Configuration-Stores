\begin{frame}
	...
	\only<1->{\begin{block}[Reasons]
			\begin{itemize}
				\item<1-> Services start / crash
					\begin{itemize}
						\item[\triangleright] Hostnames in configuration have to be changed frequently \& clients have to pull often}
					\end{itemize}
				\item<2-> Configuration files have to be replicated 
					\begin{itemize}
						\item[\triangleright] Risk of steleness
					\end{itemize}
			\end{itemize}
		\end{block}
