\begin{frame}
	...
	\onslide<1->{\begin{block}[Reasons]
			\begin{itemize}
				\item Services start / crash 
				\\ \quad $\Rightarrow$ Hostnames in configuration have to be changed frequently \& clients have to pull often
				% unnecessary traffic
				\item Configuration files have to be replicated 
				\\ \quad $\Rightarrow$ risk of staleness
			\end{itemize}
		\end{block}}

	Solution: Configuration Store with monitoring $\Rightarrow$ changes can be pushed to clients
\end{frame}
