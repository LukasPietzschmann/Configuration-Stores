...
\begin{frame}
	...
	\talknote{Raft: High Consistency, but Performance worsens with increasing Node Count (Recommended: 7 nodes)}
	\talknote{Surf: Only have eventual consistency, but scales better with more Nodes -> up to 5000 clients}
