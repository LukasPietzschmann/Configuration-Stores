...
\begin{frame}
	...
	\begin{columns}[b]
		\begin{column}{0.5\textwidth}
			\onslide<1->{\emph{Raft} Protocol (Consensus)}
			\begin{itemize}
		...
		\onslide<4->{\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				\item<5-> Distribute and perform \emph{node health checks}
...
\begin{frame}
	...
	\begin{tikzpicture}
		...
		\end{scope}
	\end{tikzpicture}
	\footnote{Based on \autocite[Consul Architecture]{ConsulDoc23}}
...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> Consensus algorithm for state machine replication\footnote{\autocite{raft14}}
...
\begin{frame}
		...
		\begin{itemize}
			...
			\item<2-> \emph{Reads}: three consistency modes:			\begin{description}[labelsep=0.5em]
